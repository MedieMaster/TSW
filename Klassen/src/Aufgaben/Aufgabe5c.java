...
public class Aufgabe5c {
	...
	public Aufgabe5c() {
		this.klassenname = " ";
		this.klassenlehrer_name = "???";
		this.anzahl_schueler = 0;
		this.anzahl_woechentlichestunden = 0;
	}

	public Aufgabe5c(String klassenname, String klassenlehrer_name, int anzahl_schueler, int anzahl_woechentlichestunden) {
	...
	public Aufgabe5c(String klassenname, String klassenlehrer_name) {
		this.klassenname = klassenname;
		this.klassenlehrer_name = klassenlehrer_name;
	}
