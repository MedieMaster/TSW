...
public class PlaylistGUI {
	...
	public Component getGUI() {
		...
		entfernen.addActionListener(e ->{
			...
			mv.getPlaylistenListe().get(playlist.getSelectedIndex()).delete(medienlist.getSelectedIndex());
			
			medienlist.remove(medienlist.getSelectedIndex());
		...
		medienlist.addListSelectionListener(e ->{
			if(medienlist.isSelectionEmpty()) {
				entfernen.setEnabled(false);
				oeffnen.setEnabled(false);
			}
			else {
				entfernen.setEnabled(true);
